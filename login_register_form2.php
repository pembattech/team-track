...
<script>
    $(document).ready(function () {
        // Front-end validation using jQuery
        $('#registrationForm').submit(function (event) {
            ...
            // AJAX request to validate data on the server
            $.ajax({
                type: 'POST',
                url: 'partial/register.php',
                data: formData,
                dataType: 'json',
                success: function (response) {
                    if (response.success) {
                        alert('Registration successful!'); // You can redirect to another page here.
                    } else {
...
if (isset($_SESSION['user_id']) && isset($_SESSION['username'])) {
    ...
    <div class="form-structor">
        ...
        <div class="signup slide-up">
            ...
            <form action="partial/register.php" method="POST" id="registrationForm>
